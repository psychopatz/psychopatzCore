...
| Production LOC scored | 32022 |
| Logical subsystems | 28 |
| Production findings | 54 |
| Test findings | 6 |
...
| Traits | 17.5 | 87.5/100 | 67.0% | 54.1% | 2 | 281 | 1 | 1 | 1 |
| Semantics | 4.9 | 96.4/100 | 78.5% | 62.7% | 15 | 2143 | 2 | 1 | 0 |
| Conversation | 3.7 | 99.8/100 | 81.5% | 63.4% | 4 | 839 | 1 | 3 | 1 |
| Translation | 3.7 | 100.0/100 | 78.5% | 58.9% | 3 | 881 | 0 | 3 | 2 |
...
| Animation | 0.1 | 100.0/100 | 54.6% | 41.0% | 1 | 411 | 0 | 0 | 0 |
...
| production | `LARGE_FUNCTION` | MEDIUM | 12 |
...
| `ARC-A9B84449B9` | `LARGE_FUNCTION` | MEDIUM | HIGH (90%) | UI | PsychopatzConversationChat:render spans 151 lines. |
| `ARC-B4FCB5E659` | `LARGE_FUNCTION` | MEDIUM | HIGH (90%) | UI | Model.Build spans 219 lines. |
| `ARC-E574008E12` | `LARGE_FUNCTION` | MEDIUM | HIGH (90%) | Semantics | search spans 133 lines. |
...
| `ARC-F2813C8430` | `LARGE_FUNCTION` | MEDIUM | HIGH (90%) | Semantics | PatternMatcher.Match spans 139 lines. |
...
| `ARC-98F4B175F0` | `TEST_HARNESS_EXTRACTION_CANDIDATE` | LOW | HIGH (95%) | tests | Repeated test setup appears across 36 tests (~444 repeated LOC). |
...
| `ARC-A9B84449B9` | `PsychopatzConversationChat:render` | `Contents/mods/PsychopatzCore/common/media/lua/client/PsychopatzCore/UI/Conversation/Parts/PsychopatzConversationChat.lua` | 207 | 151 |
...
| `ARC-F2813C8430` | `PatternMatcher.Match` | `Contents/mods/PsychopatzCore/common/media/lua/shared/PsychopatzCore/Semantics/PsychopatzSemanticPatternMatcher.lua` | 215 | 139 |
| `ARC-E574008E12` | `search` | `Contents/mods/PsychopatzCore/common/media/lua/shared/PsychopatzCore/Semantics/PsychopatzSemanticPatternMatcher.lua` | 218 | 133 |
